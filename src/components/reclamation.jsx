          ...
          <div className="contact-form-center">
            ...
            <form onSubmit={handleSubmit}>
              <div className="input-icon-container">
                ...
                <input type="text" name="name" placeholder="Nom" value={name} onChange={handleChange} />
              </div>
              <div className="input-icon-container">
              ...
              <div className="input-icon-container">
                ...
                <input type="text" name="id" placeholder="Id-Produit" value={id} onChange={handleChange} />
              </div>
              <div className="input-icon-container">
                <FaExclamationCircle className="input-icon" />
                <textarea name="subject" placeholder="Votre Probléme" value={subject} onChange={handleChange}></textarea>
              </div>
